...
const settings = ['Edit My Profile','Profile-Keren DEMO', 'Profile-Justo DEMO','History', 'Logout'];
const settingsEndpoints = ['/EditMyProfile','/profile?user=3', '/profile?user=2','/history', '/'];

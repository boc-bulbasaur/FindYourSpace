...
const columns: GridColDef[] = [
  { field: 'conf_code', headerName: 'Confirmation Code', width: 180, headerAlign: 'center', align: 'center' },
  ...
  { field: 'total', headerName: 'Total', width: 128, headerAlign: 'center' },
...
export default function O_RenderHistory({ ownerHistory }) {
  ...
  console.log('Render History: ', ownerHistory)

  return (

    <div style={{ height: 400, width: '100%' }}>
      <DataGrid
        getRowId={(row) => row.conf_code}
